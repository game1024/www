---
title: "正式开源! Penio"
description: "本文分享了Penio开源的历程，以及使用 Tauri 开发过程中的实践经验和踩坑总结。"
...
## 窗口透明
:::warning
macos，需要设置`macOSPrivateApi=true`，才能使用transparent api，不过需要注意开启了这个选项后，无法在App Store上架应用
:::
...
## JS创建窗口
在tauri中，如果你想要用javascript创建窗口, 你必须将command声明为`async command`，否则会让整个应用阻塞住
